...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='post',
            name='ingredients',
            field=models.ManyToManyField(blank=True, related_name='posts', through='blog.PostIngredient', to='blog.ingredient'),
        ),
        migrations.AddField(
            model_name='recipestep',
            name='post',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='steps', to='blog.post'),
        ),
        migrations.AddField(
            model_name='post',
            name='tags',
